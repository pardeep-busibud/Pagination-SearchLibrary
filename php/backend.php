<?php
	...
	{   
	    ...
	    $value=array(array('string','mock_test_db.mock_test_tbl','name','name ,id,email,phone ,gender ','id'),array('email','mock_test_db.mock_test_tbl','email','name,id,email,phone,gender','id'));
	    $query_data=array();
       ...
       // echo "<pre>"; print_r(array($result,$get_query_and_data['string'],$get_query_and_data['get_ids']));
