<?php
	...
	require_once('/xampp/htdocs/Pagination-SearchLibrary/search_library/search.php');

	require_once('/xampp/htdocs/Pagination-SearchLibrary/pagination1.0/prepared_query.php');
