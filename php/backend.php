<?php
	...
	{   
		...
		$value=array(array('string','mock_test_tbl','Email','null as name,id,null as Email,null as phone,null as gender','id'));
		$query_data=array();
	    ...
	    $get_ids=$obj->get_ids($result,$get_query_and_data['email'],$get_query_and_data['get_ids']);
