<?php
	...
	{   
	    ...
	    $params=array();
	    $buffer_range= json_decode($_POST['buffer_data'], true);
	    $data_per_page=$_POST['data_per_page'];
	    $input=$_POST['input_value'];
	    $total_length=0;
	    $max_page=0;
	    ...
	    {
	        $where= " mock_test_tbl.id IN (" . implode(',', array_column($get_ids, 'id')) . " )";
