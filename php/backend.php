<?php
	...
	$application_obj->Myconnection ($connection_mock_chat,"localhost","root","pagination");
	...
	{   
	    ...
	    $value=array(array('email','pagination.mock_test_tbl','Email','Name as name,Id,Email as email,Phone as phone,Gender as gender','id'));
	    $query_data=array();
	    ...
	    $table1_to=array("pagination.mock_test_tbl","pagination.mock_test_tbl");
