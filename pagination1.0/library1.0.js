        ...
        {   
            ...
            { 
                $("head").append('<script type="text/javascript" src="pagination1.0/simplePagination.js-master/jquery.simplePagination.js"></script>'); // Changed Path for compatibility with Project name
                $("head").append('<link rel="stylesheet" href="pagination1.0/simplePagination.js-master/simplePagination.css">'); // Changed Path for compatibility with Project name
